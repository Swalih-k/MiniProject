<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="S_REGISTRATION.aspx.cs" Inherits="miniprojectmaster.S_REGISTRATION" %>
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        ...
                                                        <asp:TextBox ID="f_name" class="form-control" runat="server"></asp:TextBox>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        ...
                                                        <asp:TextBox ID="l_name" class="form-control" runat="server"></asp:TextBox>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        ...
                                                        <asp:TextBox ID="confirm_password" class="form-control" runat="server"></asp:TextBox>
