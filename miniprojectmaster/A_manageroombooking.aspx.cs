...
namespace miniprojectmaster
{
    public partial class WebForm11 : System.Web.UI.Page
    {
        ...
        public void grid()
        {
            ...
            string query = "select * from s_roombooking inner join s_registration on s_roombooking.r_id=s_registration.r_id  where room_id=" + h_id + "";
        ...
        protected void LinkButton2_Click(object sender, EventArgs e)
        {
            ...
            string query = "delete from s_roombooking where room_id=" + room_id + "";
            dboperation db = new dboperation();
